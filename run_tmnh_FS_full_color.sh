...
# mkdir -p outputs_fsopt_shared/kitchen
# mkdir -p logs 
...
#   --z_list_m="$z_list" \
#   --loader mipnerf --scene kitchen \
#   --out_dir outputs_fsopt_shared/kitchen
...
CUDA_VISIBLE_DEVICES=3 python main.py \
  ...
  --target_cache_path outputs_fsopt_shared/kitchen/target_amp_red_Tref24_D7.pt \
  --out_dir outputs_fsopt_24_red/kitchen \
...
CUDA_VISIBLE_DEVICES=4 python main.py \
  ...
  --save_images --save_complex=true --mi_T=24 \
  --target_cache_path outputs_fsopt_shared/kitchen/target_amp_green_Tref24_D7.pt \
  --out_dir outputs_fsopt_24_green/kitchen \
...
CUDA_VISIBLE_DEVICES=5 python main.py \
  ...
  --save_images --save_complex=true --mi_T=24 \
  --target_cache_path outputs_fsopt_shared/kitchen/target_amp_blue_Tref24_D7.pt \
  --out_dir outputs_fsopt_24_blue/kitchen \
